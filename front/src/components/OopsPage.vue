<template>
  <div class="h-screen bg-custom-black flex items-center justify-center custom-scroll">
    ...
    <section class="error">
      ...
      <div class="error__content">
        <div class="error__message message">
          <h1 class="message__title text-gray">Oups !</h1>
          <p class="message__text text-gray">Il semblerait que la page que vous cherchez ait pris un autre chemin.
            N'hésitez pas à réessayer, ou me contacter !<i class="fas fa-laugh-wink"></i></p>
        </div>
